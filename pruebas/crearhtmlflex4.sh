...
div {
  ...
  flex-direction: $FLEX_DIRECTION; # Establecer la dirección flexible
  flex-wrap: $FLEX_WRAP; # Establecer el ajuste de línea flexible
  flex-flow: $FLEX_FLOW; # Establecer flex-flow
  order: $ORDER; # Establecer el order
  flex-basis: $FLEX_BASIS; # Establecer flex-basis
  flex-grow: $FLEX_GROW; # Establecer flex-grow
  flex-shrink: $FLEX_SHRINK; # Establecer flex-shrink
